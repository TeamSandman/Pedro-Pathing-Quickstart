...
public class SpecimenAuto extends OpMode {
    ...
    private final Pose startPose = new Pose(8, 65.9375, Math.toRadians(0));// x was 9 then 8.375

    /** Scoring Pose of our robot. It is facing the submersible at a -45 degree (315 degree) angle. */
    private final Pose scorePose = new Pose(30, 65.9375 , Math.toRadians(0));//x was 37.25
