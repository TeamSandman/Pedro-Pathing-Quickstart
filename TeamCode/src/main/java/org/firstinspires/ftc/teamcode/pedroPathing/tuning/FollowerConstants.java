...
public class FollowerConstants {
    ...
    private static double xMovement = 72.8142;
    private static double yMovement = 50.842;
    ...
    public static double headingPIDFFeedForward = 0.0275; //was 0.01
    ...
    public static double mass = 12.6;

    // Centripetal force to power scaling
    public static double centripetalScaling = 0.000465;


    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double forwardZeroPowerAcceleration = -55.1226;//was -59.1226

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -61.9275;
    ...
    public static double zeroPowerAccelerationMultiplier = 3;//was 4


    // When the robot is at the end of its current Path or PathChain and the velocity goes below
    // this value, then end the Path. This is in inches/second.
    // This can be custom set for each Path.
    public static double pathEndVelocityConstraint = 4;//was 0.1 then 2
    ...
    // This can be custom set for each Path.
    public static double pathEndTValueConstraint = 0.995;//was 0.995

    // When the Path is considered at its end parametrically, then the Follower has this many
    // milliseconds to further correct by default.
    // This can be custom set for each Path.
    public static double pathEndTimeoutConstraint = 500-400;
